...
if not is_venv_installed():
    log.warning("The fare_kpis_clickhouse_elt example DAG requires virtualenv, please install it.")
else:
    ...
    def fare_kpis_clickhouse_elt():
        """
        ### TaskFlow API example using virtualenv
        This is a simple data pipeline example which demonstrates the use of
        the TaskFlow API using three simple tasks for Extract, Transform, and Load.
        """
        pipeline = FaresClickhouseToSQLPipeline()
    ...
    fare_kpis_clickhouse_elt_dag = fare_kpis_clickhouse_elt()
